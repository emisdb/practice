	...
	'house_sale'=>array(
		'gcn_farm'	=>
			array(
				...
				'Address'			 => array(2,array( 'id_reg','str_reg','str_dept', 'str_district', 'str_street', 'house_number', 'house_korpus', 'house_letter' )),
				"CadastralNumber"	 => array(0,'cadastral_number'),
				"BedroomsCount"		 => array(0,'amount_rooms'),
				...
				"WcLocationType"	=> array(5,'gcn_list_country_wc','id_wc'),
				"HasGas"			=> array(5,'gcn_list_country_gas','id_gas'),
				"HasDrainage"		=> array(5,'gcn_list_farm_sewerage','id_sewerage'),
				"RepairType"		=> array(5,'gcn_list_country_interior','id_interior'),
				"HasPhone"			=> array(5,'gcn_list_phone','fraction'),
				"HasSecurity"		=> array(5,'gcn_list_country_security','id_security'),
				"HasBathhouse"		=> array(0,'bath'),
				"HasGarage"			=> array(0,'garage'),
				"HasPool"			=> array(0,'swimming_pool'),
				'Building'			=> array(3,array(
					array('FloorsCount'		=> array(0,"floors")),
					array('BuildYear'		=> array(0,"year_build")),
					array('MaterialType'	=> array(5,"gcn_list_country_walls","id_wall_mater")),
					array('HeatingType'		=> array(5,"gcn_list_country_heat","id_head")),
				)),
				'Land'			=> array(3,array(
